...
export default function prepareForRuntime(code, valueCache, options, babelConfig) {
  const pluginOptions = loadLinariaOptions(options.pluginOptions);
  const babelOptions = loadBabelOptions(options.filename, pluginOptions?.babelOptions);
