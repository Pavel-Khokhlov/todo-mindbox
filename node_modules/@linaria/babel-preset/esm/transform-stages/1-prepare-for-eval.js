...
export function prepareForEvalSync(resolveCache, codeCache, resolve, resolvedFile, options, stack = []) {
...
export default async function prepareForEval(resolveCache, codeCache, resolve, file, options, stack = []) {
