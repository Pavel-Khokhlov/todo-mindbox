...
function collector(babel, options) {
  ...
  return {
    ...
    pre(file) {
      ...
      const prepareStageResults = (0, _prepareForEval.prepareForEvalSync)(resolveCache, codeCache, _utils.syncResolve, entryPoint, {
      ...
      const evalStageResult = (0, _eval.default)(resolveCache, codeCache, evalCache, prepareStageResults.map(r => r.code), {
