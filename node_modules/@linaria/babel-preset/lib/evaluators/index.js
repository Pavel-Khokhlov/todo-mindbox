 ...
 */
function evaluate(resolveCache, codeCache, evalCache, code, options) {
  ...
  const m = new _module.default(filename !== null && filename !== void 0 ? filename : 'unknown', pluginOptions, resolveCache, codeCache, evalCache);
  m.dependencies = [];
  m.evaluate(code);
  return {
    value: m.exports,
