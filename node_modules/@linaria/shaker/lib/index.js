...
const shaker = (filename, options, text, only = null) => {
  ...
  const transformOptions = (0, _utils.loadBabelOptions)(filename, (0, _utils.buildOptions)(options === null || options === void 0 ? void 0 : options.babelOptions, getShakerConfig(only)));
